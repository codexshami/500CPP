# Solution 2: Unit Testing with pytest

## Approach Explanation
Apply the appropriate technique for Unit Testing with pytest.

## Step-by-Step Logic
1. Analyze the input for Unit Testing with pytest.
...
## Code
```python
# Solution for Unit Testing with pytest
