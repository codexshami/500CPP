# Solution 8: TDD: Red-Green-Refactor

## Approach Explanation
Apply the appropriate technique for TDD: Red-Green-Refactor.

## Step-by-Step Logic
1. Analyze the input for TDD: Red-Green-Refactor.
...
## Code
```python
# Solution for TDD: Red-Green-Refactor
