# Solution 3: K-Nearest Neighbors

## Approach Explanation
Apply the appropriate technique for K-Nearest Neighbors.

## Step-by-Step Logic
1. Analyze the input for K-Nearest Neighbors.
...
## Code
```python
# Solution for K-Nearest Neighbors
