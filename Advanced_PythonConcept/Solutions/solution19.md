# Solution 19: Operator Overloading

## Approach Explanation
Apply the appropriate technique for Operator Overloading.

## Step-by-Step Logic
1. Analyze the input for Operator Overloading.
...
## Code
```python
# Solution for Operator Overloading
