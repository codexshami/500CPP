# Solution 16: Chat Bot (Rule-based)

## Approach Explanation
Apply the appropriate technique for Chat Bot (Rule-based).

## Step-by-Step Logic
1. Analyze the input for Chat Bot (Rule-based).
...
## Code
```python
# Solution for Chat Bot (Rule-based)
