# Solution 7: Generator Expressions

## Approach Explanation
Apply the appropriate technique for Generator Expressions.

## Step-by-Step Logic
1. Analyze the input for Generator Expressions.
...
## Code
```python
# Solution for Generator Expressions
