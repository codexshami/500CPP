# Solution 7: Database Normalization

## Approach Explanation
Apply the appropriate technique for Database Normalization.

## Step-by-Step Logic
1. Analyze the input for Database Normalization.
...
## Code
```python
# Solution for Database Normalization
