# Solution 15: Nested Loops Pattern

## Approach Explanation
Apply the appropriate technique for Nested Loops Pattern.

## Step-by-Step Logic
1. Analyze the input for Nested Loops Pattern.
...
## Code
```python
# Solution for Nested Loops Pattern
