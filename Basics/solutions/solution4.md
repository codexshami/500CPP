# Solution 4: If-Else Conditions

## Approach Explanation
Apply the appropriate technique for If-Else Conditions.

## Step-by-Step Logic
1. Analyze the input for If-Else Conditions.
...
## Code
```python
# Solution for If-Else Conditions
